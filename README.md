...
```javascript
import normal from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-normal@v0.3.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Normal, cdf, entropy, kurtosis, logcdf, logpdf, mean, median, mgf, mode, pdf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-normal@v0.3.1-deno/mod.js';
```
